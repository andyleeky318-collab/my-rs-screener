...
# def load_amd_data():
#     df = yf.download("DRAM", period="1y", interval="1d", auto_adjust=False, progress=False)
...
KNOWN_STOCKS = [
    'KLIC', 'IWM', 'HBMX', 'PWR', 'EUV', 'GRID', 'MAGS', 'SPCX', 'IBM', 'ELV', 'OSCR', 'QNT', 'HYDR', 'ALGM', 'LGN', 'IESC', 'AEHR', 'ACLS', 'MKSI', 'SMTC', 'AMKR', 
