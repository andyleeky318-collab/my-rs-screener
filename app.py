...
def render_pine_rs_table_html(rows, max_height):
    ...
    def rs_cell_style(v):
        base = "padding:1px 4px;text-align:right;font-size:10px;border:1px solid #ccc;white-space:nowrap;"
    ...
    header_html = (
        "<tr>"
        "<th style='padding:1px 4px;background:#ffffff;color:#000000;text-align:left;font-size:10px;border:1px solid #ccc;white-space:nowrap;'></th>"
        "<th style='padding:1px 4px;background:#ffffff;color:#000000;text-align:center;font-size:10px;border:1px solid #ccc;white-space:nowrap;'>RS(5)</th>"
        "<th style='padding:1px 4px;background:#0000ff;color:#ffffff;text-align:center;font-size:10px;border:1px solid #ccc;white-space:nowrap;'>RS(21)*</th>"
        "<th style='padding:1px 4px;background:#ffffff;color:#000000;text-align:center;font-size:10px;border:1px solid #ccc;white-space:nowrap;'>RS(63)</th>"
        "<th style='padding:1px 4px;background:#ffffff;color:#000000;text-align:center;font-size:10px;border:1px solid #ccc;white-space:nowrap;'>RS(126)</th>"
        "</tr>"
    )
    ...
    for i, r in enumerate(rows):
        ...
        body_html += (
            f"<tr>"
            f"<td style='padding:1px 4px;background:{name_bg};color:{name_color};text-align:left;font-size:10px;border:1px solid #ccc;font-weight:bold;white-space:nowrap;'>{sym}</td>"
